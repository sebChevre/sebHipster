...
import ch.sebooom.config.Constants;
import ch.sebooom.SebHipsterApp;
import ch.sebooom.domain.Authority;
import ch.sebooom.domain.PersistentToken;
import ch.sebooom.domain.User;
import ch.sebooom.repository.AuthorityRepository;
import ch.sebooom.repository.PersistentTokenRepository;
import ch.sebooom.repository.UserRepository;
import ch.sebooom.security.AuthoritiesConstants;
import ch.sebooom.service.MailService;
import ch.sebooom.service.dto.UserDTO;
import ch.sebooom.web.rest.errors.ExceptionTranslator;
import ch.sebooom.web.rest.vm.KeyAndPasswordVM;
import ch.sebooom.web.rest.vm.ManagedUserVM;
import ch.sebooom.service.UserService;

...
import ch.sebooom.config.audit.AuditEventConverter;
import ch.sebooom.domain.PersistentAuditEvent;
...
import static ch.sebooom.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
